  ...
  ({ label, error, helperText, className = '', id, ...props }, ref) => {
    ...
    return (
      <div className="w-full">
        {label && (
          <label htmlFor={inputId} className="block mb-2 text-sm font-medium text-[var(--color-text-primary)]">
            {label}
        ...
        <input
          ...
          className={`w-full px-4 py-2.5 bg-white border-2 rounded-lg transition-all duration-200 min-h-[44px]
            ${error 
            ...
            outline-none text-[var(--color-text-primary)] placeholder:text-[var(--color-text-tertiary)]
